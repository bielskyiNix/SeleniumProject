...
public class SiteForPracticeTestVersion2 {
    ...
    public void searchResultAndAddToCartTest(String searchQuery, String searchResult){
        ...
        ArrayList<Float> priceList = new ArrayList<>(); // создаем списко и далее заполняем его, ценами товаров, если товар со скидкой то записываем его старую цену (так как сортирует по ней)
